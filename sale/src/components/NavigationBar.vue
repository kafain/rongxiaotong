    ...
    <div class="menu-content" v-cloak>
      <el-menu
        ...
        <el-submenu index="8" v-else>
          ...
          <el-menu-item index="8-7" @click.native="feedbackManage" v-if="$store.getters.isAdmin">反馈信息</el-menu-item>
          <el-menu-item index="8-8" @click.native="logout">退出</el-menu-item>
